          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-container rounded-xl p-6 border border-gray-200 dark:border-gray-700 hover:border-[#1A6DFF]/30 dark:hover:border-[#1A6DFF]/30 transition-all duration-300">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-semibold text-[#1E293B] dark:text-white">Производительность</h3>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[#64748B] dark:text-gray-400">Конверсия</span>
                  <span className="font-medium text-[#1E293B] dark:text-white">78.5%</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[#64748B] dark:text-gray-400">Время обработки</span>
                  <span className="font-medium text-[#1E293B] dark:text-white">2.3 ч</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[#64748B] dark:text-gray-400">Повторные покупки</span>
            ...
            <div className="bg-container rounded-xl p-6 border border-gray-200 dark:border-gray-700 hover:border-[#1A6DFF]/30 dark:hover:border-[#1A6DFF]/30 transition-all duration-300">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-semibold text-[#1E293B] dark:text-white">Анализ выручки</h3>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[#64748B] dark:text-gray-400">Рост vs прошлый месяц</span>
                  <span className="font-medium text-green-600 dark:text-green-400">+24%</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[#64748B] dark:text-gray-400">Маржинальность</span>
                  <span className="font-medium text-[#1E293B] dark:text-white">42.8%</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[#64748B] dark:text-gray-400">LTV клиента</span>
                  <span className="font-medium text-[#1E293B] dark:text-white">₽15,280</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-container rounded-xl p-6 border border-gray-200 dark:border-gray-700 hover:border-[#1A6DFF]/30 dark:hover:border-[#1A6DFF]/30 transition-all duration-300">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-semibold text-[#1E293B] dark:text-white">География</h3>
                <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-purple-100 to-purple-200 dark:from-purple-900/30 dark:to-purple-800/30 flex items-center justify-center">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[#64748B] dark:text-gray-400">Москва</span>
                  <span className="font-medium text-[#1E293B] dark:text-white">35%</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[#64748B] dark:text-gray-400">СПб</span>
                  <span className="font-medium text-[#1E293B] dark:text-white">22%</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[#64748B] dark:text-gray-400">Регионы</span>
                  <span className="font-medium text-[#1E293B] dark:text-white">43%</span>
                </div>
              </div>
            </div>
          </div>
