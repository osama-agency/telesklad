  ...
  return (
    <div>
      ...
      <div className="relative">
        <input
          className="form-datepicker w-full rounded-lg border border-[#E2E8F0] dark:border-dark-3 bg-white dark:bg-dark-2 px-3 py-2 text-sm font-normal text-foreground dark:text-white placeholder:text-muted-foreground outline-none transition focus:ring-gradient active:border-accent dark:active:border-primary"
