        ...
        <form className="flex items-center justify-between space-x-4.5">
          <div className="relative w-full">
            <input
              ...
              className="h-13 w-full rounded-[7px] border border-stroke bg-gray-1 py-2 pl-5 pr-22.5 text-dark outline-none focus:ring-gradient dark:border-dark-3 dark:bg-dark-2 dark:text-white"
            />
          ...
          <button className="flex h-13 w-full max-w-13 items-center justify-center rounded-md bg-gradient-primary text-white hover:bg-gradient-primary-hover">
            <SendMessageIcon />
          </button>
        </form>
      </div>
