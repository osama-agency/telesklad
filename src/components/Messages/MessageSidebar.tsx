      ...
      <div className="custom-scrollbar flex max-h-full flex-col overflow-y-auto px-6 py-7.5">
        <form className="sticky top-0 z-20 mb-4 bg-white pb-5 dark:bg-gray-dark">
          <div className="relative">
            <input
              type="text"
              className="w-full rounded-[7px] border border-stroke bg-gray-2 py-2.5 pl-4.5 pr-12 text-body-sm text-dark outline-none focus:ring-gradient dark:border-dark-3 dark:bg-dark-2 dark:text-white"
              placeholder="Search..."
            />
