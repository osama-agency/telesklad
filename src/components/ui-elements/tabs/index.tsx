...
const tabTriggerStyles = cva("font-medium hover:border-primary", {
  variants: {
    variant: {
      default:
        "rounded-[7px] border border-stroke px-5 py-[7px] bg-gray-2 dark:bg-dark-2 dark:border-dark-3 text-dark dark:text-white data-[active=true]:bg-gradient-primary data-[active=true]:text-white data-[active=true]:border-primary hover:bg-gradient-primary hover:text-white",
      plain:
