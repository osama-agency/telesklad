...
function NavigationLink({ children, disabled, ...props }: NavigationLinkProps) {
  return (
    <Link
              className="flex size-8 items-center justify-center rounded-[3px] hover:bg-gradient-primary hover:text-white aria-disabled:pointer-events-none aria-disabled:opacity-50"
