          ...
          <form action="#">
            <div className="mb-5">
              ...
              <input
                ...
                className="w-full rounded-[7px] border border-stroke bg-white px-4.5 py-3 text-dark focus:ring-gradient focus-visible:outline-none dark:border-dark-3 dark:bg-dark-2 dark:text-white"
              />
            </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button onClick={() => setFiles(null)}>
                        <XIcon />
                          ...
                          <button className="flex w-full items-center justify-center gap-2 rounded-[7px] bg-gradient-primary px-4.5 py-3.5 font-medium text-white hover:bg-gradient-primary-hover">
              <CirclePlusIcon />
              Add task
            </button>
          </form>
