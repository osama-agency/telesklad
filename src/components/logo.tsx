export function Logo() {
  return (
    <div className="flex items-center gap-3">
      ...
      <svg width="40" height="40" viewBox="0 0 221 221" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
      ...
      {/* Текст telesklad */}
      <span className="text-2xl font-bold font-golos text-dark dark:text-white">
        telesklad
      </span>
    </div>
  );
