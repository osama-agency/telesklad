...
const buttonStyles = cva(
  "flex items-center gap-2 font-medium border-y hover:bg-gradient-primary hover:text-white hover:border-primary dark:hover:border-primary [&_svg]:size-5",
  {
    variants: {
      size: {
      ...
      isActive: {
        true: "bg-gradient-primary text-white border-primary",
